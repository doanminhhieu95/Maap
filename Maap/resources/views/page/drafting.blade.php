...
<div class="container-fluid page-content drafting">
    <div class="row h-100">
                ...
                <div class="d-flex flex-row align-items-center content">
                    ...
                    <div class="col-md-8 h-100 bg-white p-0 middle">
                        <div class="row bg-map h-100">
                            ...
                            <div class="col-6 col-md-4 scroll-img haft top left">
                                <ul class="h-100">
                            ...
                            <div class="col-6 col-md-4 scroll-img haft top right">
                                <ul class="h-100">
                            ...
                            <div class="col-6 col-md-4 scroll-img haft bot left">
                                <ul class="h-100">
                            ...
                            <div class="col-6 col-md-4 scroll-img haft bot right">
                                <ul class="h-100">
                                @foreach($hinhanh3 as $hinhanh)
                                    <li class="h-100">
                                        <img class="h-100" src="maaptl/img/{{$hinhanh->name}}" />
